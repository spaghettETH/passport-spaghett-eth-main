...
async function main() {
  ...
  try {
    ...
    const eventName = "SpaghettiETH 2024";
    const totalCheckpoints = await contract._checkpointsCounter();
    const checkpointSlug = "SPAGHETTETH_2024_TALK_" + totalCheckpoints;
    const checkpointImage =
      "https://spaghetteth.io/assets/checkpoints/" + checkpointSlug + ".png";
